...
UPDATEBOT_M4E_MODIFY_FILES := $(shell git diff --name-only $${GIT_LAST_TAG:-HEAD~1}..HEAD roles/v1alpha1/m4e roles/v1alpha1/web/nginx/ roles/v1alpha1/database/postgres 2>/dev/null | wc -l )
